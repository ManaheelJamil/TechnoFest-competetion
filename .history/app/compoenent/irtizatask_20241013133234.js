...
const Irtizatask = () => {
  return (
    <div className='flex justify-center  w-full h-100vh banner' >
        ...
        <div className='flex flex-col justify-items-center text-gray-700 text-center items-center m-28'  >
        ...
        <p className='text-[36px] font-bold'>
            ...
            <button className='mt bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded'>
                Become a volunteer
            </button>
            </div>

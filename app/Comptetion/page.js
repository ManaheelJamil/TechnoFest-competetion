...
const page = () => {
  ...
  return (
    <div className='flex my-20 m-5 flex-col'>


         <h1 className="text-center lg:m-[50px] m-[20px] text-5xl font-bold ">
         ALL CATEGORIES
      </h1>
      <div className='flex flex-col md:flex-row items-center'>

                <div class="relative grid h-[25rem] lg:w-[50%] flex-col items-end justify-center overflow-hidden  bg-white">
              ...
              <div class="relative grid h-[25rem] w-[50%] flex-col items-end justify-center overflow-hidden  bg-white">
                ...
                <div class="relative text-center lg:p-6 px-6 py-14 md:px-12">
                  <h2 class="mb-6 lg:text-xl font-medium text-white">
